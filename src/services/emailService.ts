...
class EmailService {
    ...
    private generateOtpEmailTemplate(otp: string, purpose: 'verification' | 'password_reset'): string {
    ...
    async sendTicketNotification(
        email: string,
        type: 'new_ticket' | 'new_message' | 'status_changed',
        data: any
    ): Promise<boolean> {
        try {
            let subject = '';
    ...
    private generateNewTicketEmailTemplate(data: {
        ticketNumber: string;
        title: string;
        category: string;
        priority: string;
    ...
    private generateNewMessageEmailTemplate(data: {
        ticketNumber: string;
        senderName: string;
        message: string;
        ticketUrl: string;
    ...
    private generateStatusChangedEmailTemplate(data: {
        ticketNumber: string;
        title: string;
        newStatus: string;
        ticketUrl: string;
