 ...
 *         description: Unauthorized
 */
router.get("/", authenticateToken, listUserSubscriptions);
 ...
 *         description: Unauthorized
 */
router.get("/history", authenticateToken, getUserSubscriptionHistory);
 ...
 *         description: Unauthorized
 */
router.get("/payments", authenticateToken, getUserPaymentHistory);
 ...
 *         description: Unauthorized
 */
router.post("/:id/renew", authenticateToken, renewSubscription);
 ...
 *         description: Unauthorized
 */
router.post("/payments/session", authenticateToken, createPaymentSession);

router.post(
  "/payments/cashfree/finalize",
  authenticateToken,
  finalizeCashfreePayment,
);
 ...
 */
router.post("/payments/:paymentId/refund", authenticateToken, processRefund);
 ...
 *         description: Payment not found
 */
router.get("/payments/:transactionId", authenticateToken, getPaymentDetails);
