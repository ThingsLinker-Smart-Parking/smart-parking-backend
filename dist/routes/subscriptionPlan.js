 ...
 */
router.get('/', (0, validation_1.validateQuery)(validation_1.subscriptionPlanSchemas.listFilters), subscriptionPlanController_1.getAllSubscriptionPlans);
/**
 * @swagger
 ...
 */
router.get('/:id', (0, validation_1.validateParams)(validation_1.paramSchemas.uuid), subscriptionPlanController_1.getSubscriptionPlanById);
/**
 * @swagger
 * /api/subscription-plans:
 *   post:
 ...
 */
router.post('/', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), (0, validation_1.sanitize)(), (0, validation_1.validateBody)(validation_1.subscriptionPlanSchemas.create), subscriptionPlanController_1.createSubscriptionPlan);
/**
 * @swagger
 * /api/subscription-plans/{id}:
 *   put:
 ...
 *         description: Plan name already exists
 */
router.put('/:id', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), (0, validation_1.validateParams)(validation_1.paramSchemas.uuid), (0, validation_1.sanitize)(), (0, validation_1.validateBody)(validation_1.subscriptionPlanSchemas.update), subscriptionPlanController_1.updateSubscriptionPlan);
/**
 * @swagger
 * /api/subscription-plans/{id}:
 *   delete:
 ...
 *         description: Subscription plan not found
 */
router.delete('/:id', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), (0, validation_1.validateParams)(validation_1.paramSchemas.uuid), (0, validation_1.sanitize)(), (0, validation_1.validateBody)(validation_1.subscriptionPlanSchemas.softDelete), subscriptionPlanController_1.deleteSubscriptionPlan);
/**
 * @swagger
 ...
 */
router.post('/:id/restore', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), (0, validation_1.validateParams)(validation_1.paramSchemas.uuid), subscriptionPlanController_1.restoreSubscriptionPlan);
/**
 * @swagger
 ...
 *         description: Insufficient permissions
 */
router.post('/bulk/update', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), (0, validation_1.sanitize)(), (0, validation_1.validateBody)(validation_1.subscriptionPlanSchemas.bulkUpdate), subscriptionPlanController_1.bulkUpdateSubscriptionPlans);
/**
 * @swagger
 ...
 *         description: Insufficient permissions
 */
router.put('/exchange-rate', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), (0, validation_1.sanitize)(), (0, validation_1.validateBody)(validation_1.subscriptionPlanSchemas.updateExchangeRate), subscriptionPlanController_1.updateExchangeRate);
/**
 * @swagger
 ...
 *         description: Insufficient permissions
 */
router.get('/statistics', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin', 'super_admin']), subscriptionPlanController_1.getSubscriptionPlanStats);
