 ...
 */
router.get('/overview', parkingController_1.getParkingOverview);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/slots/:slotId/details', parkingController_1.getSlotDetails);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.put('/nodes/:nodeId/update', parkingController_1.updateNodeData);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/dashboard/stats', parkingController_1.getDashboardStats);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/chirpstack/webhook', parkingController_1.handleChirpStackWebhook);
