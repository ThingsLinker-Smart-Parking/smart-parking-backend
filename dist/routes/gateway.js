 ...
 */
router.post('/webhook/node-status', gatewayController_1.updateNodeStatus);
/**
 * @swagger
 ...
 */
router.post('/webhook/gateway-status', gatewayController_1.updateGatewayStatus);
 ...
 */
router.get('/available', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin']), gatewayController_1.getAvailableGateways);
/**
 * @swagger
 ...
 *         description: Access denied
 */
router.get('/my-gateways', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin']), gatewayController_1.getLinkedGateways);
/**
 * @swagger
 * /api/gateways/link:
 *   post:
 ...
 *         description: Access denied
 */
router.post('/link', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin']), gatewayController_1.linkGateway);
/**
 * @swagger
 * /api/gateways/nodes:
 *   post:
 ...
 *         description: Access denied
 */
router.post('/nodes', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin']), gatewayController_1.createNode);
/**
 * @swagger
 ...
 *         description: Access denied
 */
router.get('/statistics', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin', 'super_admin']), gatewayController_1.getGatewayStatistics);
// Super Admin routes
/**
 * @swagger
 * /api/gateways:
 ...
 *         description: Access denied
 */
router.post('/', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), gatewayController_1.createGateway);
/**
 * @swagger
 * /api/gateways:
 *   get:
 ...
 *         description: Access denied
 */
router.get('/', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin', 'admin']), gatewayController_1.getAllGateways);
/**
 * @swagger
 * /api/gateways/{id}:
 *   get:
 ...
 *         description: Access denied
 */
router.get('/:id', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), gatewayController_1.getGatewayById);
/**
 * @swagger
 * /api/gateways/{id}:
 *   put:
 ...
 *         description: Access denied
 */
router.put('/:id', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), gatewayController_1.updateGateway);
/**
 * @swagger
 * /api/gateways/{id}:
 *   delete:
 ...
 *         description: Access denied
 */
router.delete('/:id', auth_1.authenticateToken, (0, auth_1.requireRole)(['super_admin']), gatewayController_1.deleteGateway);
 ...
 *         description: Access denied
 */
router.post('/:id/unlink', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin']), gatewayController_1.unlinkGateway);
/**
 * @swagger
 ...
 *         description: Access denied
 */
router.post('/:id/assign-parking-lot', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin']), gatewayController_1.assignGatewayToParkingLot);
/**
 * @swagger
 ...
 *         description: Access denied
 */
router.get('/:id/nodes', auth_1.authenticateToken, (0, auth_1.requireRole)(['admin', 'super_admin']), gatewayController_1.getGatewayNodes);
