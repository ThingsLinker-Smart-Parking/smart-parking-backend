...
async function seedSimpleSubscriptionPlans() {
    try {
        ...
        loggerService_1.logger.info('Database connected for seeding simple subscription plans');
        ...
        if (plan) {
            ...
            loggerService_1.logger.info('Updating existing subscription plan');
        }
        else {
            // Create new plan
            ...
            loggerService_1.logger.info('Creating new subscription plan');
        }
        await planRepository.save(plan);
        loggerService_1.logger.info('Simple subscription plan saved successfully');
        ...
        loggerService_1.logger.error('Error seeding simple subscription plans:', error);
        console.error(error);
        process.exit(1);
    }
}
