...
const createEnvironmentConfig = () => {
    try {
        ...
        const config = {
            ...
            CASHFREE_ENVIRONMENT: (process.env.CASHFREE_ENVIRONMENT || 'SANDBOX').toUpperCase() ===
                'PRODUCTION'
                ? 'PRODUCTION'
                : 'SANDBOX',
            CASHFREE_RETURN_URL: (() => {
        ...
        loggerService_1.logger.error('Environment configuration validation failed', error);
        throw error;
    }
};
...
exports.env = createEnvironmentConfig();
...
loggerService_1.logger.info('Environment configuration loaded successfully', {
    nodeEnv: exports.env.NODE_ENV,
    port: exports.env.PORT,
    dbHost: exports.env.DB_HOST,
    dbPort: exports.env.DB_PORT,
    redisConfigured: !!exports.env.REDIS_URL,
    mqttConfigured: !!exports.env.MQTT_BROKER_URL,
    swaggerEnabled: exports.env.ENABLE_SWAGGER,
    monitoringEnabled: exports.env.MONITORING_ENABLED
});
